...
$lang['upload_invalid_dimensions']       = '<span style="font-size:90%;color:red">L\'image que vous tentez d\'envoyer dépasse les valeurs maximales autorisées pour la hauteur ou la largeur.';
